...
// Handle connack
  ...
  this.on('pipe', function (socket) {
    socket.on('error', this.end.bind(this));
    socket.on('close', this.end.bind(this));
  });

  Duplex.call(this);
};
util.inherits(MqttClient, Duplex);

MqttClient.prototype._write = function (chunk, encoding, callback) {
  this.conn.write(chunk, encoding);
  callback(null);
};

MqttClient.prototype._read = function () {
};

MqttClient.prototype.connect = function () {
  // Write initial connect command.
